...
@pytest.fixture
def mock_model_manager() -> unittest.mock.MagicMock:
    """ModelManager with mocked pipelines (no GPU needed)."""
    manager = unittest.mock.MagicMock(spec=ModelManager)
...
@pytest.fixture
def mock_db() -> unittest.mock.MagicMock:
    """Mock MongoDB database for unit tests."""
    mock = unittest.mock.MagicMock()
    mock.users = unittest.mock.MagicMock()
    mock.sessions = unittest.mock.MagicMock()
    mock.token_blocklist = unittest.mock.MagicMock()
    mock.user_memory = unittest.mock.MagicMock()
    mock.mood_logs = unittest.mock.MagicMock()
    mock.safety_events = unittest.mock.MagicMock()
    return mock
